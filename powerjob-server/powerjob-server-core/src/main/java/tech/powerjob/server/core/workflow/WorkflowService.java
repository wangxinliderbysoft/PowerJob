...
public class WorkflowService {
    ...
    public Long saveWorkflow(SaveWorkflowRequest req) {
        ...
        if (req.getLifeCycle() != null) {
            wf.setLifecycle(JsonUtils.toJSONString(req.getLifeCycle()));
        }
    ...
    private String validateAndConvert2String(Long wfId, PEWorkflowDAG dag) {
        ...
        return JsonUtils.toJSONString(dag);
    }
    ...
    public long copyWorkflow(Long wfId, Long appId) {
        ...
        PEWorkflowDAG dag = JsonUtils.parseObject(copyWorkflow.getPeDAG(), PEWorkflowDAG.class);
        ...
        copyWorkflow.setPeDAG(JsonUtils.toJSONString(dag));
    ...
    private void fillWorkflow(WorkflowInfoDO wfInfo) {
        ...
        try {
            dagInfo = JsonUtils.parseObject(wfInfo.getPeDAG(), PEWorkflowDAG.class);
        } catch (Exception e) {
        ...
        wfInfo.setPeDAG(JsonUtils.toJSONString(dagInfo));
    }
