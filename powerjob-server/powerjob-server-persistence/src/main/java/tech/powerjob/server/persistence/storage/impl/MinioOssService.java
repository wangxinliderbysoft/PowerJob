...
public class MinioOssService extends AbstractDFsService {
     ...
     * @param bucketName 桶名
     */
    public void initOssClient(String bucketName) {
        log.info("[Minio] init OSS by config: endpoint={}, bucketName={}, accessKey={}, secretKey={}",  bucketName);
